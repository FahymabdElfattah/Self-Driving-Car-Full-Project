...
train_data = object_detector.DataLoader.from_pascal_voc(
    'self_driving_cars/train',
    'self_driving_cars/train',
    ['green','panel001','panel010','panel011','panel100','panel101','panel110','red','yellow','forward','right']
)

val_data = object_detector.DataLoader.from_pascal_voc(
    'self_driving_cars/validate',
    'self_driving_cars/validate',
    ['green','panel001','panel010','panel011','panel100','panel101','panel110','red','yellow','forward','right']
)
...
# Export the model
model.export(export_dir='.', tflite_filename='selfDrivingCar.tflite')

# Evaluate the tflite model
tflite_eval_result = model.evaluate_tflite('selfDrivingCar.tflite', val_data)
